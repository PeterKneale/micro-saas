...
public class Migration3 : Migration
{
    ...
    public override void Up()
    {
        ...
        Execute.Sql($"GRANT SELECT, UPDATE, INSERT, DELETE ON {Constants.TableSettings} TO {Username};");
        ...
        Execute.Sql($"CREATE POLICY {Policy} ON {Constants.TableSettings} FOR ALL TO {Username} USING ({Constants.ColumnTenantId} = current_setting('app.tenant_id')::uuid);");
