...
public class Migration2 : Migration
{
    ...
    public override void Up()
    {
        ...
        Execute.Sql($"GRANT SELECT ON {Constants.Schema}.{Constants.TableSettings} TO {Username};");
        
        // Define the policy that will be applied
        Execute.Sql($"CREATE POLICY {Policy} ON {Constants.Schema}.{Constants.TableSettings} FOR ALL TO {Username} USING (true);");
    }
